...
assert.deepEqual([...workflow.matchAll(/--allow-build=([^\s]+)/g)].map(match => match[1]), [
  '@deepseek-ai/dsh-subprocess-local', '@google/genai', 'fs-ext', 'koffi', 'node-pty', 'protobufjs',
]);
...
const hosts = '0.1.0-rc.8, 0.1.1-rc.1, 0.1.1-rc.2, 0.1.2-alpha.3, 0.1.2-alpha.4, 0.1.2-alpha.5, 0.1.2-rc.1, 0.1.3-alpha.2';
